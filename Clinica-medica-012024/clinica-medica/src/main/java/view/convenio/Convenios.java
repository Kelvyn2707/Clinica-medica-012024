...
public class Convenios extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String nome = txtEmpresa.getText().trim();
      String telefone = txtTelefone.getText().trim();
      String codigo = txtCodigo.getText().trim();
      String cnpj = txtCNPJ.getText().trim();

      if (nome.isEmpty() || telefone.isEmpty() || codigo.isEmpty() || cnpj.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Todos os campos são obrigatórios!");
      } else{
           JOptionPane.showMessageDialog(null, "Convêncio adicionado ao sistema");
           TelaPrincipal telaP = new TelaPrincipal();
           telaP.setVisible(true);    
           this.dispose();
        }
